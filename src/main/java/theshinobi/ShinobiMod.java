...
@SpireInitializer
public class ShinobiMod implements
    ...
    private static String checkResourcesPath() {
        String name = ShinobiMod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        if (!resources.exists()) {
            throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                    ...
                    "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                    "\tat the top of the " + ShinobiMod.class.getSimpleName() + " java file.");
        }
